...
export default function AdminCommunity() {
  ...
  const fetchPosts = async () => {
    try {
      const response = await fetch('http://localhost/mini%20main/project/src/backend/get_all_posts.php');
  ...
  const handleLike = async (postId: number) => {
    try {
      const response = await fetch('http://localhost/mini%20main/project/src/backend/toggle_post_like.php', {
        method: 'POST',
